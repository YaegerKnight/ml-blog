...
{% include info.html text="I've mentioned this for other tools like [Evidently](https://evidentlyai.com) before so I should also note that the [DVC online community](https://dvc.org/community) is a pretty friendly and helpful place to hang out and learn about data versioning or to troubleshoot your problems. Nobody will tell you to RTFM here and their community events are generally beginner-friendly in my experience. This makes a big difference so they should be commended for the efforts they take to foster this kind community atmosphere." %}
