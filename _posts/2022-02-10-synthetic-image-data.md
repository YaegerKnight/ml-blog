...
layout: post
description:
  "I iterated through several prototypes to get to a script that could
  autogenerate synthetic training data for my computer vision model. I hoped to
  bootstrap my training to get a bit jump in model performance."
categories: [redactionmodel, computervision, python, tools]
comments: true
author: Alex Strick van Linschoten
title:
  "It's raining bboxes: how I wrote a Python script to create 2097 synthetic
